                            ...
                            <div class="form-group row">
                                ...
                                <div class="col-sm-10">
                                    <input type="text" class="form-control" id="nombreLugar" name="nombreLugar"
                                        placeholder="Ingrese el nombre del lugar" value="{{ old('nombreLugar') }}">
                                </div>
                            </div>
                            <div class="form-group row">
                                ...
                                <div class="col-sm-10">
                                    <input type="text" class="form-control" id="direccionLugar" name="direccionLugar"
                                        placeholder="Ingrese la dirección del lugar" value="{{ old('direccionLugar') }}">
                                </div>
                            </div>
                            <div class="form-group row">
                                ...
                                <div class="col-sm-10">
                                    <input type="text" class="form-control" id="aulaLugar" name="aulaLugar"
                                        placeholder="Ingrese el aula del lugar" value="{{ old('aulaLugar') }}">
                                </div>
                            </div>
                            <div class="form-group row">
                                ...
                                <div class="col-sm-10">
                                    <input type="text" class="form-control" id="telefonoLugar" name="telefonoLugar"
                                        placeholder="Ingrese el teléfono del lugar" value="{{ old('telefonoLugar') }}">
                                </div>
                            </div>

                            <button class="btn btn-warning btn-block" type="submit" id="submitFormPeriodo"><i
                                    class="fas fa-plus"></i> Agregar lugar</button>
                        </form>
                    </div>
                </div>
            </div>
