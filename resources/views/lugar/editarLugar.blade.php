                  ...
                  <form id="formEditaLugar" method="POST">
                    ...
                    <div class="form-group row">
                        ...
                        <div class="col-sm-10">
                            ...
                            <input type="text" class="form-control" id="nombreLugar" name="nombreLugar" placeholder="Ingrese el nombre del lugar" value="{{ $lugar->nombreLugar }}">
                        </div>
                    </div>
                    <div class="form-group row">
                        <label for="direccionLugar" class="col-sm-2 col-form-label">Descripcion</label>
                        <div class="col-sm-10">
                            <input type="text" class="form-control" id="direccionLugar" name="direccionLugar" placeholder="Ingrese la direccion del lugar" value="{{ $lugar->direccionLugar }}">
                        </div>
                    </div>
                    <div class="form-group row">
                        <label for="direccionLugar" class="col-sm-2 col-form-label">Aula</label>
                        <div class="col-sm-10">
                            <input type="text" class="form-control" id="aulaLugar" name="aulaLugar" placeholder="Ingrese el aula del lugar" value="{{ $lugar->aulaLugar }}">
                        </div>
                    </div>
                    <div class="form-group row">
                        <label for="telefonoLugar" class="col-sm-2 col-form-label">Teléfono</label>
                        <div class="col-sm-10">
                            <input type="text" class="form-control" id="telefonoLugar" name="telefonoLugar" placeholder="Ingrese el teléfono del lugar" value="{{ $lugar->telefonoLugar }}">
                        </div>
                    </div>
                    <button class="btn btn-primary btn-block" type="submit"><i class="far fa-edit"></i> Editar lugar</button>
                  </form>
                </div>
            </div>
        </div>
