                    ...
                    <div class="container-fluid">
                        <form id="formFecha" method="POST">
                            ...
                            <div class="row fechaForm" hidden>
                                ...
                                <div class="col-md-6">
                                    <input type="text" class="form-control" id="fechaInicio" name="fechaInicio"
                                        placeholder="Establezca la fecha" onkeydown="event.preventDefault()"
                            ...
                            <div class="row inicioForm" hidden>
                                ...
                                <div class="col-md-6">
                                    <input type="text" class="form-control" id="horaInicio" name="horaInicio"
                                        placeholder="Establezca la hora inicio" onkeydown="event.preventDefault()"
                                        autocomplete="off" value="">
                                </div>
                            </div>
                            <br class="brForm" hidden>
                            <div class="row finForm" hidden>
                                ...
                                <div class="col-md-6">
                                    <input type="text" class="form-control" id="horaFin" name="horaFin"
                                        placeholder="Establezca la hora fin" onkeydown="event.preventDefault()"
                                        autocomplete="off" value="">
                                </div>
                            </div>
                            ...
                            <div class="row observacionForm" hidden>
                                ...
                                <div class="col-md-9">
                                    <textarea class="md-textarea form-control observacion" rows="2" id="observacion"
                                        name="observacion"></textarea>
                                </div>
                            </div>
                            <br>
                            <button class="btn btn-warning btn-block" type="submit" id="submitFormFecha" hidden><i
                                    class="fas fa-edit"></i> Establecer estado de horario</button>
                        </form>
                        <hr>
                        <div class="row">
