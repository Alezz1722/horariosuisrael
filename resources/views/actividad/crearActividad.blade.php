                    ...
                    <div class="card-body">
                        ...
                        <form id="formActividad" method="POST">
                            ...
                            <div class="form-group row">
                                ...
                                <div class="col-sm-10">
                                    <input type="text" class="form-control" id="descripcionActividad"
                                        name="descripcionActividad" placeholder="Ingrese la descripción de la actividad"
                                        value="{{ old('descripcionActividad') }}">
                                </div>
                            </div>
                            <div class="form-group row">
                            ...
                            <button class="btn btn-warning btn-block" type="submit" id="submitFormPeriodo"><i
                                    class="fas fa-plus"></i> Agregar actividad</button>
                        </form>
                    </div>
                </div>
            </div>
