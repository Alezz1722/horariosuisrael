                  ...
                  <form id="formEditaActividad" method="POST">
                    ...
                    <div class="form-group row">
                        ...
                        <div class="col-sm-10">
                            ...
                            <input type="text" class="form-control" id="nombreActividad" name="nombreActividad" placeholder="Ingrese el nombre de la actividad" value="{{ $actividad->nombreActividad }}">
                        </div>
                    </div>
                    <div class="form-group row">
                        <label for="descripcionActividad" class="col-sm-2 col-form-label">Descripcion</label>
                        <div class="col-sm-10">
                            <input type="text" class="form-control" id="descripcionActividad" name="descripcionActividad" placeholder="Ingrese la descripcion de la actividad" value="{{ $actividad->descripcionActividad }}">
                        </div>
                    </div>
                    <div class="form-group row">
                        ...
                        <div class="col-sm-10">
                            <select class="form-control" name="idPeriodo">
                                ...
                                @foreach ($periodos as $key => $value)
                                    <option value="{{ $value->idPeriodo }}" {{ ( $value->idPeriodo == $actividad->idPeriodo) ? 'selected' : '' }}>
                        ...
                        <div class="col-sm-10">
                            <select class="form-control" name="idLugar">
                                ...
                                @foreach ($lugares as $key => $value)
                                    <option value="{{ $value->idLugar }}" {{ ( $value->idLugar == $actividad->idLugar) ? 'selected' : '' }}>
