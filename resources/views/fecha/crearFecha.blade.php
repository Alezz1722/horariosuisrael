            ...
            <div class="col-md-8">
                <div class="card">
                    <div class="card-header d-flex justify-content-between align-items-center">
                        ...
                        <a href="{{ route('fecha', ['id' => $actividad->idActividad]) }}"
                    ...
                    <div class="card-body">
                        ...
                        <div class="card text-center">
                            <div class="card-body">
                                ...
                                <p class="card-text text-muted">{{ $periodo->nombrePeriodo }} ( De <b
                                        class="fechaInicioPeriodo">{{ $periodo->fechaInicioPeriodo }}</b> hasta <b
                                        class="fechaFinPeriodo">{{ $periodo->fechaFinPeriodo }}</b>)</b>
                            </div>
                        </div>
                        <br>
                        <form id="formFecha" method="POST">
                            ...
                            <div class="form-group row" id="fechaInicioDiv">
                                ...
                                <div class="col-sm-9">
                                    <input type="text" class="form-control" id="fechaInicioFecha" name="fechaInicioFecha"
                                        ...
                                        onkeydown="event.preventDefault()" autocomplete="off" value="" disabled>
                                </div>
                            </div>
                            ...
                            <div class="form-group row">
                                ...
                                <div class="col-sm-9">
                                    <input type="text" class="form-control" id="horaInicioFecha" name="horaInicioFecha"
                                        ...
                                        value="{{ old('horaInicioFecha') }}" disabled>
                                </div>
                            </div>
                            <div class="form-group row">
                                ...
                                <div class="col-sm-9">
                                    <input type="text" class="form-control" id="horaFinFecha" name="horaFinFecha"
                                        ...
                                        value="{{ old('horaFinFecha') }}" disabled>
                                </div>
                            </div>
                            ...
                            <button class="btn btn-warning btn-block" type="submit" id="submitFormFecha"><i
                                    class="fas fa-plus"></i> Agregar horario</button>
                        </form>
                    </div>
                </div>
            </div>
