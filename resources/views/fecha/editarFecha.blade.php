        ...
        <div class="col-md-8">
            <div class="card">
                <div class="card-header d-flex justify-content-between align-items-center">
                    ...
                    <a href="{{route('fecha', [ 'id' => $fecha->idActividad->idActividad] )}}" class="btn btn-primary btn-sm"><i class="fas fa-arrow-circle-left"></i> Regresar a lista de horarios</a>
                </div>
                <div class="card-body">
                    ...
                    <div class="card text-center" >
                        <div class="card-body">
                          ...
                          <p class="card-text text-muted">{{$fecha->idActividad->idPeriodo->nombrePeriodo}} ( De <b class="fechaInicioPeriodo">{{$fecha->idActividad->idPeriodo->fechaInicioPeriodo }}</b> hasta <b class="fechaFinPeriodo">{{ $fecha->idActividad->idPeriodo->fechaFinPeriodo }}</b>)</b>
                  ...
                  <form id="formFecha" method="POST">
                    ...
                    <div class="form-group row" id="fechaInicioDiv" >
                        ...
                        <div class="col-sm-9">
                            ...
                            <input type="text" class="form-control" id="fechaInicioFecha" name="fechaInicioFecha" placeholder="Establezca la fecha inicio del horario" onkeydown="event.preventDefault()" autocomplete="off" value="">
                        </div>
                    </div>
                    <div class="form-group row" id="fechaFinDiv" >
                        ...
                        <div class="col-sm-9">
                            ...
                            <input type="text" class="form-control" id="fechaFinFecha" name="fechaFinFecha" placeholder="Establezca la fecha fin del horario" onkeydown="event.preventDefault()" autocomplete="off" value="">
                        </div>
                    </div>
                    <div class="form-group row">
                    ...
                    <div class="form-group row">
                        ...
                        <div class="col-sm-9">
                            ...
                            <input type="text" class="form-control" id="horaInicioFecha" name="horaInicioFecha" placeholder="Ingrese la hora inicial del horario" onkeydown="event.preventDefault()" value="{{ old('horaInicioFecha') }}">
                        </div>
                    </div>
                    <div class="form-group row">
                        ...
                        <div class="col-sm-9">
                            ...
                            <input type="text" class="form-control" id="horaFinFecha" name="horaFinFecha" placeholder="Ingrese la hora fin del horario" onkeydown="event.preventDefault()" value="{{ old('horaFinFecha') }}">
                        </div>
                    </div>
                    <input type="text" class="form-control" id="idActividad" name="idActividad" value="{{ $fecha->idActividad->idActividad }}" hidden>
                    <button class="btn btn-primary btn-block" type="submit" id="submitFormFecha"><i class="fas fa-edit"></i> Editar horario</button>
                  </form>
                </div>
            </div>
        </div>
